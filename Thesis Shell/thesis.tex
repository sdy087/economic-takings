...
\makeindex[name=noleg, title = {Norway}, columns = 2, intoc]
\makeindex[name=prepno, title = {Norway}, columns = 1, intoc]
\makeindex[name=intleg, title = {Other Law Instruments}, columns = 2, intoc]
...
\begin{abbreviations}
\item[CPR]{Common Pool Resource \hspace{6.7cm} 50}
...
\include{Chapter1/endelig_intro}
\include{Chapter1/endelig_1}
\include{Chapter2/endelig_2}
\include{Chapter2/endelig_3}
\include{Chapter3/endelig_4}
%\include{Chapter4/chapter4_final}
\include{Chapter5/endelig_5}
\include{Chapter1/endelig_finale}
