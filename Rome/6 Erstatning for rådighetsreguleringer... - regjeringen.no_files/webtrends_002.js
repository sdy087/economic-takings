...
// Created: 140201 - support at arena dot no
	...
	****************************************************************************/
	...
	Webtrends.dcs.prototype = {
		init: function (config) {
			...
			this.timezone = this['timezone'] = sd('timezone', 1);
			this.enabled = this['enabled'] = sd('enabled', true);
			this.i18n = this['i18n'] = sd('i18n', false);
			this.re = (function () {
			...
			this._downloadtypes = extendArray(sd('downloadtypes', "csv,doc,docx,epub,eps,gif,gzip,jpg,pdf,png,pps,ppsx,ppt,pptx,rar,rtf,sdv,txt,xls,xlsx,zip").toLowerCase().split(","));
